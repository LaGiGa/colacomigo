        ...
        <div className={`rounded-xl border transition-all duration-300 ${enabled ? 'border-border bg-card' : 'border-border/40 bg-card/40 opacity-70'
            ...
            <div className="flex items-center justify-between p-5">
                ...
                <div className="flex items-center gap-3">
                    {saving && <Icons.Loader2 className="h-4 w-4 animate-spin text-muted-foreground" />}
    ...
    return (
        <div className="max-w-2xl space-y-8">
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl border border-blue-500/20 bg-blue-500/5">
                <Icons.AlertCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
            ...
            <div className="space-y-4">
                <h2 className="text-xs font-black uppercase tracking-widest text-muted-foreground flex items-center gap-2">
                    <Icons.Zap className="h-3.5 w-3.5" /> Regras Automáticas
                </h2>
                ...
                <div className="rounded-xl border border-border bg-card">
                    <div className="flex items-center justify-between p-5">
                        ...
                        <div className="flex items-center gap-3">
                            {savingField === 'free_shipping' && <Icons.Loader2 className="h-4 w-4 animate-spin text-muted-foreground" />}
                        ...
                        <>
                            ...
                            <div className="p-5 space-y-4">
                                ...
                                <div className="flex items-center gap-2 p-3 rounded-lg bg-green-500/5 border border-green-500/20">
                                    <Icons.CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0" />
            ...
            <div className="space-y-4">
                <h2 className="text-xs font-black uppercase tracking-widest text-muted-foreground flex items-center gap-2">
                    <Icons.Truck className="h-3.5 w-3.5" /> Opções de Entrega
                </h2>
                ...
                >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-primary-foreground text-xs font-bold hover:bg-primary/90 transition-colors disabled:opacity-50"
                    >
                        <Icons.Save className="h-3.5 w-3.5" /> Salvar nome
                    </button>
                </ConfigSection>
                ...
                >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-primary-foreground text-xs font-bold hover:bg-primary/90 transition-colors disabled:opacity-50"
                    >
                        <Icons.Save className="h-3.5 w-3.5" /> Salvar configurações
                    </button>
                </ConfigSection>
                ...
                >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-primary-foreground text-xs font-bold hover:bg-primary/90 transition-colors disabled:opacity-50"
                    >
                        <Icons.Save className="h-3.5 w-3.5" /> Salvar CEP de origem
                    </button>
                    <div className="flex items-start gap-2 p-3 rounded-lg bg-yellow-500/5 border border-yellow-500/20">
                        <Icons.AlertCircle className="h-4 w-4 text-yellow-500 flex-shrink-0 mt-0.5" />
