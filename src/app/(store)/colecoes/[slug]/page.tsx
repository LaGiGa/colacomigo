    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="container-store py-20">
                <div className="mb-12">
                    <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase">{colecao.name}</h1>
                    <p className="text-neutral-400 mt-4 max-w-xl">{colecao.description}</p>
                </div>
