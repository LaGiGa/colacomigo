    ...
    return (
        <div className="fixed bottom-5 right-5 z-50">
            <a
                ...
                className="group relative flex h-14 items-center gap-2 rounded-full border-2 border-white/80 bg-[#25D366] px-4 text-black shadow-[0_8px_24px_rgba(37,211,102,0.45)] transition-all hover:scale-105 hover:shadow-[0_12px_30px_rgba(37,211,102,0.55)] active:scale-95"
            ...
            >
                ...
                <span className="hidden sm:flex flex-col leading-none">
                    <span className="text-[9px] font-black uppercase tracking-widest text-black/70">Atendimento rápido</span>
