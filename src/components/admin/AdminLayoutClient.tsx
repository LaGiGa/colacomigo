...
import {
    Layout, LayoutDashboard, Package, ShoppingCart, Users,
    Tag, Boxes, TrendingUp, LogOut, Store,
    Ticket, Layers, Truck, MoreHorizontal, ChevronLeft, X, Settings2, MessageCircle
} from 'lucide-react'
